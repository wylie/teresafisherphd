    ...
    <ThemeProvider theme={isDarkTheme ? darkTheme : lightTheme}>
      ...
      <Wrapper>
        ...
        <div style={{display: "flex", marginBottom: "2rem"}}>
          <div style={{margin: "1rem", backgroundColor: "#efefef", width: "100%", height: "5rem", display: "flex", alignItems: "center", justifyContent: "center"}}>
            <Type secondary style={{fontWeight: "600"}} color="white">#EFEFEF</Type>
          </div>
          <div style={{margin: "1rem", backgroundColor: "#ccc", width: "100%", height: "5rem", display: "flex", alignItems: "center", justifyContent: "center"}}>
            <Type secondary style={{fontWeight: "600"}} color="white">#CCCCCC</Type>
          </div>
        ...
        <br/>
        <img src="https://i.pinimg.com/originals/e6/d0/6a/e6d06a607c8133e5152290b4b5224f63.jpg" style={{boxShadow: "0 0 0 3px #e9c46a"}} alt="" />
      </Wrapper>  
    </ThemeProvider>
  )
};
